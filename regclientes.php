...
<form class="form-horizontal" role="form" id="frm" name="formregistrar" action="clienteservices.php" method="post" enctype="multipart/form-data">
		...
		<script type="text/javascript">			
			...
			var pager_selector = "#grid-pager";
				...
				jQuery(grid_selector).jqGrid({
					...
					url:'serv_carga_clientes.php',
					data: grid_data,
					datatype: "json",
					height: 400,
					colNames:['Acciones', 'Código', 'Tip. Documento', 'Documento','Nombres','Ap. Paterno','Ap. Materno', 'Estado'],
					colModel:[
						{name:'select',index:'select', width:70, fixed:true, hidden: false, sortable:false, resize:false,
							formatter:'actions', 
							formatoptions:{ 
								keys:true,
						...
						{name:'idecliente',index:'idecliente', width:10, editable: true, hidden: false },
						{name:'tipdocumento', index:'tipdocumento', align: "center", edittype : 'select', formatter: "select", formatoptions: {value:{"1":"DNI","2":"PEX","3":"CE"}}, width:30,editable: false,editoptions:{value:"1:DNI;2:PEX;3:CE", size:"60",maxlength:"150"}},
						{name:'documento', index:'documento', width:20, editable: false},
						{name:'nombres', index:'nombres', width:60,editable: true,editoptions:{size:"60",maxlength:"150"}},
						{name:'ape_paterno', index:'ape_paterno', width:60,editable: true,editoptions:{size:"60",maxlength:"150"}},
						{name:'ape_materno', index:'ape_materno', width:60,editable: true,editoptions:{size:"60",maxlength:"150"}},
