...
<!--
				...
				<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Asignación de Personas a Cursos
								<small>
...
<form class="form-horizontal" role="form" id="frm" name="formregistrar" action="personalxcapacitacionservices.php" method="post" enctype="multipart/form-data">
