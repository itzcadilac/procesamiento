...
require_once 'config.php'; 
 ...
 if($oper=='edit'){
 mysql_query("UPDATE personal SET nota_teorica='".$nota_teorica."', nota_practica='".$nota_practica."', nota_final='".$nota_final."', cargo=UPPER('".$cargo."'), observaciones=UPPER('".$observaciones."') where idepersonal='".$idepersonal."'")
 or die(mysql_error());
 //mysql_close($db);
 }
