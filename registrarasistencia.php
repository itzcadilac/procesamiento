...
<form class="form-horizontal" role="form" id="frm" name="formregistrar" action="cierreasistencia.php" method="post" enctype="multipart/form-data">
			   ...
			   <div class="col-md-offset-3 col-md-9">
					...
					<script>
							$(function(){
								...
								var url = 'busquedahorariosasistencia.php';
								var text = ''
							...
							$(function(){
								$('#horario_r').on('change', function(){
									...
									var url = `serv_carga_asistencia.php?horario=${horario}`;
									//console.log({url})
		...
		<script type="text/javascript">
			...
			var pager_selector = "#grid-pager";
				...
				jQuery(grid_selector).jqGrid({
					...
					url:'serv_carga_asistencia.php',
					data: grid_data,
					datatype: "json",
					height: 400,
					colNames:['', 'Código', 'Num. Documento',  'Nombres','Ape. Paterno', 'Ape. Materno', 'Asistencia', 'Empresa', 'Observaciones'],
					colModel:[
						...
						{name:'idepersonal', align: "center", index:'idepersonal', width:20, editable: true, hidden: true },
						...
						{name:'asistencia', align: "center", index:'asistencia', width:20,editable: true,edittype:'checkbox', editoptions: {value:"1:0"}, formatter: "checkbox", formatoptions:{disabled : true}},
