...
<!--
				...
				<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Registro de Tipos de Parihuelas
								<small>
...
$sqlcontra = "SELECT * from empresas ORDER BY ideempresa ASC";
...
?>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre Parihuela: </label>
						<div class="col-sm-9">
							<input type="text" name="descripcionparihuela" id="descripcionparihuela" placeholder="" class="form-control" required/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Peso Parihuela: </label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="codificacion" id="codificacion"  placeholder="" class="form-control" required/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Empresa: </label>
						<div class="col-sm-9">
							<select class="form-control" name="ideempresa" id="ideempresa" required>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" name="costo" id="costo"  placeholder="" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Orden: </label>
						<div class="col-sm-9">
							<input type="number" name="orden" id="orden"  placeholder="" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre de Imagen: </label>
						<div class="col-sm-9">
		...
		<script type="text/javascript">			
			...
			var pager_selector = "#grid-pager";
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					height: 400,
					colNames:['Acciones', 'Código', 'Parihuela', 'Peso', 'Estado'],
					colModel:[
