...
?>
				...
				<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Cierre de Capacitaciones y Envío de Informes
								<small>
...
<form class="form-horizontal" role="form" id="frm" name="formregistrar" action="cyedocs.php" method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
					...
					<script>
							...
							$(function(){
								...
								var url = 'busquedahorarioscierrecapac.php';
							...
							$(function(){
								$('#horario_r').on('change', function(){
									...
									{
										var url = `serv_carga_cierrecapac.php?horario=${horario}`;
										$("#tablanotasext").show();
									 	$("#tablanotasint").hide();
...
?>
		...
		<script type="text/javascript">
			...
			function clickFunction(valor)
					{
						//console.log(valor);
						//alert(valor);

						href="../receipt/ticket?id=<?php echo $d->idsucli; ?>"
        ...
        $('#timepicker1').timepicker({
			...
			var pager_selector1 = "#grid-pagerext";
				...
				jQuery(grid_selector1).jqGrid({
					...
					url:'serv_carga_cierrecapac.php',
					data: grid_data,
					datatype: "json",
					height: 400,
					//colNames:['', 'Código', 'Num. Documento',  'Nombres','Ape. Paterno', 'Ape. Materno', 'Cargo', 'Nota T.', 'Nota P.', 'Nota F.', 'Empresa', 'Observaciones', ''],
					colNames:['', 'Código', 'Documento',  'Remitente','Cargo R.', 'Empresa', 'Fecha Reg.', 'Fecha Res.', 'Lugar', 'Instructor', 'idecal', ''],
					colModel:[
						{name:'select',index:'select', width:80, fixed:true, sortable:false, resize:false, hidden: true,
							formatter:'actions',
							formatoptions:{
								keys:true,
						...
						{name:'iddoc',index:'iddoc', width:50, editable: true, hidden: true },
						{name:'titulodoc', index:'titulodoc', width:50,editable: false,editoptions:{size:"60",maxlength:"150"}},
						{name:'remitente',index:'remitente', width:60, editable: false},
						{name:'cargoremitente', index:'cargoremitente', width:20,editable: false,editoptions:{size:"60",maxlength:"150"}},
						{name:'razonsoc', index:'razonsoc', width:60,editable: false,editoptions:{size:"60",maxlength:"150"}},
						{name:'fecha', index:'fecha', width:30,editable: true,editoptions:{size:"60",maxlength:"150"}},
						{name:'fecharesultados', index:'fecharesultados', width:20,editable: true,editoptions:{size:"60",maxlength:"150"}},
						{name:'lugar', index:'lugar', width:40,editable: true,editoptions:{size:"60",maxlength:"150"}},
						{name:'instructor', index:'instructor', width:60, sortable:true, editable: false,editoptions:{size:"60",maxlength:"150"}},
						{name:'iddocumento_cuerpo', index:'iddocumento_cuerpo', width:20,editable: false, hidden: true,editoptions:{size:"60",maxlength:"150"}},
						//{name:'observaciones', index:'observaciones', width:60,editable: true,editoptions:{size:"60",maxlength:"150"}},
						{name:'iddoc',index:'iddoc', align: "center", width:50,sorttype:"text",formatter: buttonFunction},
//						{name: "closed", width: 70, align: "center", formatter: "checkbox", formatoptions: { disabled: false},edittype: "checkbox", editoptions: {value: "Yes:No", defaultValue: "Yes"}, stype: "select", searchoptions: { sopt: ["eq", "ne"], value: ":Any;true:Yes;false:No" } }
				...
				function buttonFunction(cellvalue, options, rowObject)
							...
							//console.log(rowObject[10]);
							return "<a type='button' href='cyedocs.php?id=" + rowObject[10] + "' class='btn btn-info'><i class='ace-icon fa fa-check bigger-110' title='Generar Informe'> Generar Informe</i></a>";
							}
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'nota_final', index:'nota_final', width:20, formatter: rowColorFormatter, sortable:true, editable: true,editoptions:{size:"60",maxlength:"150"}},
...
//						{name: "closed", width: 70, align: "center", formatter: "checkbox", formatoptions: { disabled: false},edittype: "checkbox", editoptions: {value: "Yes:No", defaultValue: "Yes"}, stype: "select", searchoptions: { sopt: ["eq", "ne"], value: ":Any;true:Yes;false:No" } }
				...
				function rowColorFormatter(cellVallue, options, rowObject){
					if(cellVallue > 0)
