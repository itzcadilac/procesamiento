		...
		<script type="text/javascript">			
			...
			var pager_selector = "#grid-pager";
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					height: 400,
					colNames:['Acciones', 'Código', 'Capacitación','Fecha y Hora','Instructor (a)','Cupos Totales','Cupos Disponibles'],
					colModel:[
						{name:'select',index:'select', width:80, fixed:true, hidden: true, sortable:false, resize:false,
							formatter:'actions', 
							formatoptions:{ 
								keys:true,
						...
						{name:'idecalendcapacitaciones',index:'idecalendcapacitaciones', width:60, editable: false, hidden: true },
						{name:'desccapacitacion',index:'desccapacitacion', width:60, editable: false},
						{name:'hora', index:'hora', width:60,editable: false,editoptions:{size:"60",maxlength:"150"}},
						{name:'nombresape', index:'nombresape', width:60,editable: false,editoptions:{size:"60",maxlength:"150"}},
						{name:'cupos', index:'cupos', width:60,editable: true,editoptions:{size:"60",maxlength:"150"}},
						{name:'cuposdispo', index:'cuposdispo', width:60,editable: true,editoptions:{size:"60",maxlength:"150"}}
					...
					caption: "Capacitaciones por Instructor"
