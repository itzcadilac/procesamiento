...
<html lang="en">
	...
	<body class="no-skin">
			<?php
				include("cabecera_generalcap.php");
			?>
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form class="form-horizontal" role="form" id="frm" name="formcambiopass" action="cambiarpassc.php" method="post" onsubmit="return validar(this);">
						<input type="hidden" id="idecapacitador"  name="idecapacitador" value="<?php echo $_SESSION['idecapacitador']; ?>"/>
					<!--
						<div class="row">
