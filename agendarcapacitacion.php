...
return /\d/.test(String.fromCharCode(keynum));
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Lugar de Capacitación: </label>
						<div class="col-sm-9">
							<input type="text" name="lugar_capacitacion" id="lugar_capacitacion" placeholder="" class="form-control"/>
						</div>
					</div>
					</div>
						<div  class="form-group" >
		...
		<script type="text/javascript">			
			...
			var pager_selector = "#grid-pager";
				...
				jQuery(grid_selector).jqGrid({
					...
					url:'serv_carga_capacitaciones.php',
					data: grid_data,
					datatype: "json",
					height: 400,
					colNames:['Acciones', 'Código', 'Capacitación','Fecha y Hora','Capacitador(a)','C. Totales','C. Disponibles', 'Lugar de Capacitación', 'Estado'],
					colModel:[
						...
						{name:'idecalendcapacitaciones',index:'idecalendcapacitaciones', align: "center", width:8, editable: true, hidden: true },
						{name:'desccapacitacion',index:'desccapacitacion', width:45, editable: false},
						{name:'hora', index:'hora', width:20,editable: false,editoptions:{size:"60",maxlength:"150"}},
						{name:'nombresape', index:'nombresape', width:40,editable: false,editoptions:{size:"60",maxlength:"150"}},
						{name:'cupos', index:'cupos', width:10, align: "center",editable: true,editoptions:{size:"60",maxlength:"150"}},
						{name:'cuposdispo', index:'cuposdispo', align: "center", width:15,editable: true,editoptions:{size:"60",maxlength:"150"}}, 
						{name:'lugar_capacitacion', index:'lugar_capacitacion', width:50,editable: true,editoptions:{size:"60",maxlength:"150"}},
						{name:'estado', index:'estado', align: "center", width:15,editable: true,edittype:'checkbox', editoptions: {value:"1:0"}, formatter: "checkbox", formatoptions:{disabled : true}}
					...
					editurl: "serv_actualiza_capacitaciones.php",
