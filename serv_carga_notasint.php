<?php
 ...
 $response->rows[$i]['cell']=array("",utf8_encode($row['idepersonal']),utf8_encode($row['documento']),utf8_encode($row['nombres']),utf8_encode($row['ape_paterno']),utf8_encode($row['ape_materno']),utf8_encode($row['cargo']),utf8_encode($row['nota_final']),utf8_encode($row['empresa']),utf8_encode($row['observaciones'])); $i++;
 } 
