<?php
 ...
 $response->rows[$i]['cell']=array("",utf8_encode($row['idepersonal']),$row['documento'],$row['nombres'],$row['ape_paterno'],utf8_encode($row['ape_materno']),utf8_encode($row['ruc']),utf8_encode($row['empresa'])); $i++;
 } 
